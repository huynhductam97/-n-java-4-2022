...
public class CTHoaDonDAO {
	...
	public ArrayList docDSCTHD() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Lỗi đọc chi tiết hóa đơn");
		}
		return dscthd;
	}
	public void themCTHD(CTHoaDonDTO cthd) {
		...
		cthd.getDonGia()+"','"+cthd.getSoLuong()+"','"+cthd.getThanhTien()+"')";
			...
			// TODO: handle exception
			JOptionPane.showMessageDialog(null, "Lỗi thêm vào chi tiết hóa đơn");
		}
	}
	public ArrayList LocHD(String ma) {
		...
		try {
			...
			// TODO: handle exception
			JOptionPane.showMessageDialog(null, "Lỗi lọc theo mã");
		}
		return kqLoc;
	}
